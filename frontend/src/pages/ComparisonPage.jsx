      ...
      <div className="card p-6">
        ...
        <div className="flex flex-wrap gap-3 mb-6">
          {comparisonData.map(user => (
            <div
              key={user.id}
              className="flex items-center gap-2 px-4 py-2 bg-primary-50 dark:bg-primary-900/20 rounded-lg"
            >
        ...
        {selectedUsers.length < 5 && (
          <div>
            <input
              ...
              className="w-full px-4 py-3 border border-gray-300 dark:border-dark-600 rounded-lg bg-white dark:bg-dark-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary-500 focus:border-transparent outline-none mb-4"
            />
              ...
              {availableUsers
                ...
                .map(user => (
                  <button
                    ...
                    className="w-full flex items-center justify-between p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-dark-700 transition-colors"
                  >
              ...
              <table className="w-full">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    {comparisonData.map(user => (
                      <td key={user.id} className="py-3 px-4 text-center font-semibold text-primary-500">
