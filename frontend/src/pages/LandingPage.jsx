...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-dark-900">
      ...
      {/* Platforms Section */}
      <section id="platforms" className="py-20 px-6 bg-white dark:bg-dark-800">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
            {platforms.map((platform) => (
              <div
                key={platform.name}
                className="flex flex-col items-center gap-3 p-6 rounded-lg border border-gray-200 dark:border-dark-700 hover:border-primary-500 dark:hover:border-primary-500 transition-colors"
              >
                <img
                  src={platform.logo}
                  alt={platform.name}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              ...
              >
                <div className="w-12 h-12 rounded-lg bg-primary-50 dark:bg-primary-900/20 flex items-center justify-center mb-4">
      ...
      {/* Demo Section */}
      <section id="demo" className="py-20 px-6 bg-white dark:bg-dark-800">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">
            ...
            <Link to="/dashboard" className="btn-primary text-lg px-8 py-3 inline-flex items-center gap-2">
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <div className="card p-12 bg-gradient-to-r from-primary-500 to-purple-600">
      ...
      {/* Footer */}
      <footer className="border-t border-gray-200 dark:border-dark-700 bg-white dark:bg-dark-800 py-12 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                ...
                <li><a href="#platforms" className="hover:text-gray-900 dark:hover:text-white">Platforms</a></li>
                <li><a href="#demo" className="hover:text-gray-900 dark:hover:text-white">Demo</a></li>
              </ul>
            </div>
            <div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between pt-8 border-t border-gray-200 dark:border-dark-700">
            <p className="text-sm text-gray-600 dark:text-gray-400">
